                                        ...
                                        function response2() {
                                            if(ajaxRequest.readyState == 4 && ajaxRequest.status == 200) {
                                                if(ajaxRequest.responseText == "true") {
                                                    ...
                                                    updateUserList(currentPage, pagination, document.getElementById("search-user").value);
                ...
                function updateUserList(page, userPerPage, user) {
                    ...
                    function response() {
                        if(ajaxRequest.readyState == 4 && ajaxRequest.status == 200) {
                            ...
                            document.getElementById("pagination-area").innerHTML = "<div class=\"right\">" + paginationHTML + "</div>";
